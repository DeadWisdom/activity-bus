...
def log_activity(activity):
    ...
    return {
        "type": "Log",
        "content": f"Activity logged: {activity_type}",
        "context": activity.get("id")
    }
...
def process_create(activity):
    ...
    if not created_object:
        return {
            "type": "Error",
            "content": "Create activity missing 'object' field",
            "context": activity.get("id")
        }
    ...
    return {
        "type": "Log",
        "content": f"Created {object_type} processed",
        "context": activity.get("id")
    }
...
def process_follow(activity):
    ...
    if not follow_target:
        return {
            "type": "Error",
            "content": "Follow activity missing 'object' field",
            "context": activity.get("id")
        }
