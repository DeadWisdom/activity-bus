...
from activity_bus.rules import load_rules, validate_rule


def test_validate_rule() -> None:
    """Test validating a rule with correct structure."""
    valid_rule = {"id": "test.rule", "match": {"type": "Test"}, "effect": ["test.effect"]}
    ...
    single_effect_rule = {"id": "test.rule", "match": {"type": "Test"}, "effect": "test.effect"}
...
def test_validate_rule_invalid() -> None:
...
@pytest.mark.asyncio
async def test_load_rules() -> None:
