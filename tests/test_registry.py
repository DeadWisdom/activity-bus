...
def test_registry_register() -> None:
    ...
    effect_data = registry.register(effect_id="test.effect", func=test_effect, priority=50, description="Test effect")
...
def test_registry_get() -> None:
    ...
    registry.register(effect_id="test.effect", func=test_effect)
...
def test_registry_list_effects() -> None:
    ...
    registry.register(effect_id="test.effect1", func=test_effect1, priority=50)

    registry.register(effect_id="test.effect2", func=test_effect2, priority=100)
